...
AFTER INSERT
AS
CASE WHEN COLUNA = 2 THEN INSERT INTO Medico(id_usuario, CRM) VALUES (SELECT USUARIO.ID_USUARIO WHERE ) ELSE 
BEGIN



INSERT INTO Usuario(Nome, RG, CPF, Endereco, DataNascimento, Email, Senha, id_tipo) VALUES ('João', '123456789', '12345678910', 'Praça Jequitiba', '04/05/2000', 'oloco@gmail.com' ,'macaco123ouro', '1'), 
('Kleber', '987647584', '84756475748', 'Paraça De Lá', '02/03/1987', 'ugabuga@gmail.com' ,'ParanáJaragua', 2), 
('Maicão', '283746584', '28374672312', 'Lugar Algum', '03/09/1999', 'feijoada123' ,'jorginpega12@hotmail.com', 3 ), 
('Jorge',  '873454523', '12312312312', 'Pra lá de bogoda', '02/09/1987', 'caminhao321', 'loucodosaco@gmail.com', 1), 
('Everson','877872634', '12374678371', 'Rua joaquin mendes, 27', '03/02/2000', 'busca123', 'geffinho@gmail.com', 2) 

INSERT INTO Paciente(id_usuario) VALUES ('2'), ('5')

INSERT INTO Medico(id_usuario, CRM) VALUES ('3', '34545RG')

INSERT INTO Especialidade(NomeEspecialidade) VALUES ('Virologista'), ('Bacteriologista'), ('Clinico Geral')
